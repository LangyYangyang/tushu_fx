...
urlpatterns = [
    ...
    path('author_analysis/', views.author_analysis, name="author_analysis"),
    path('book_analysis/', views.book_analysis, name="book_analysis"),
    path('publisher_analysis/', views.publisher_analysis, name="publisher_analysis"),
    path('user_behavior_analysis/', views.user_behavior_analysis, name="user_behavior_analysis"),
    path('book_publication_prediction/', views.book_publication_prediction, name="book_publication_prediction"),
]
